...
| <a name="input_s3_endpoint_enabled"></a> [s3\_endpoint\_enabled](#input\_s3\_endpoint\_enabled) | Set to `true` to create a VPC gateway endpoint for S3. | `bool` | `false` | no |
